        ...
        <div class="mt-6 flex h-auto w-[100%] flex-col items-center px-10">
          <div class="flex h-[70%] w-full">
            ...
            <div class="flex max-h-[95%] w-[80%]">
              <MantenimientoStep1
                v-show="infoData2.paso == 1 && !loadingData"
                :incidencia="1"
                :pasoDB="pasoDB"
                :folio="$route.params.id"
              ...
              />
              <MantenimientoStep2
                v-show="infoData2.paso == 2 && !loadingData"
                :incidencia="1"
                :pasoDB="pasoDB"
              ...
              />
              <MantenimientoStep3
                v-show="infoData2.paso == 3 && !loadingData"
                :incidencia="1"
                :folio="infoData.folio"
                :estado="infoData2.paso"
                :tipoFolio="infoData.tipo"
...
import ModalEdicionFolio from "@/views/Preventivo/ModalEdicionFolio.vue";
...
import MantenimientoStep1 from "@/components/mantenimiento/preventivo/MantenimientoStep1.vue";
import MantenimientoStep2 from "@/components/mantenimiento/preventivo/MantenimientoStep2.vue";
import MantenimientoStep3 from "@/components/mantenimiento/preventivo/MantenimientoStep3.vue";
...
const fetchData = async () => {
  await get(refDB(db, `folios/preventivos/${route.params.id}`)).then(
    (snapshot) => {
