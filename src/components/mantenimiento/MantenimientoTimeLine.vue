<template>
  <div class="mt-10 flex h-[15%] w-full justify-center">
    ...
    >
      <!-- Inicio -->
      <div @click="emits('setPaso', 1)" class="flex w-1/3 flex-col items-center justify-center cursor-pointer">
        <div
      ...
      <!-- Llegada -->
      <div @click="emits('setPaso', 2)" class="flex w-1/3 flex-col items-center justify-center cursor-pointer">
        <div
          class="flex h-14 w-14 items-center justify-center rounded-full"
          :class="[
            props.state == 2
      ...
      <!-- cierre -->
      <div @click="emits('setPaso', 3)" class="flex w-1/3 flex-col items-center justify-center cursor-pointer">
        <div
          class="flex h-14 w-14 items-center justify-center rounded-full"
          :class="[
            props.state == 3
