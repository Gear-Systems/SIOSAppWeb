<template>
  <div>
    <TransitionRoot appear :show="editarFolio" as="template" class="z-50">
      <Dialog as="div" @close="editarFolio = false" class="relative z-[999]">
        <TransitionChild
          as="template"
                ...
                <div class="flex w-[100%] flex-col items-center justify-center">
                  <div class="my-2 flex w-[100%] items-center justify-center">
                    ...
                    >
                      ...
                      <div class="flex w-[100%]">
                        <!-- {{ Object.keys(infoDataBD) }} -->
                        <Listbox v-model="infoDataBD.tipoFolio">
                  ...
                  <div class="mb-4 flex w-[100%] items-center justify-between">
                    ...
                    >
                      Distrito
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.distrito">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                            ...
                            >
                              ...
                              >
                                <!-- <ListboxOption
                                  v-slot="{ active, selected }"
                                  v-for="element in data.distritos"
                                  :value="element"
                                  as="template"
                                >
                                  <li
                    ...
                    >
                      Cluster
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.cluster">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                  ...
                  <div class="mb-4 flex w-[100%] items-center justify-between">
                    ...
                    >
                      Supervisor
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.supervisor">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                            ...
                            >
                              <span class="block truncate"> {{ infoDataBD.supervisor }} </span>
                              <span
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"
                              >
                                <SelectorIcon
                    ...
                    >
                      Técnico
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.tecnico">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                            ...
                            >
                              <span class="block truncate"> {{ infoDataBD.tecnico }} </span>
                              <span
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"
                              >
                                <SelectorIcon
                  ...
                  <div class="mb-4 flex w-[80%] items-center self-start">
                    ...
                    >
                      Falla
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.falla">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                            ...
                            >
                              <span class="block truncate"> {{ infoDataBD.falla }} </span>
                              <span
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"
                              >
                                <SelectorIcon
                  ...
                  <div class="mb-4 flex w-[80%] items-center self-start">
                    ...
                    >
                      Causa
                      <div class="flex w-[100%]">
                        <Listbox v-model="infoDataBD.causa">
                          <div class="relative mt-1 w-full">
                            <ListboxButton
                              :class="[
                                'relative w-full cursor-default rounded-lg border-2 border-[#E5E5E5] bg-white py-2 pl-3 pr-10 text-left text-black focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm',
                            ...
                            >
                              <span class="block truncate"> {{ infoDataBD.causa }} </span>
                              <span
                                class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2"
                              >
                                <SelectorIcon
                    ...
                    >
                      Clientes afectados
                      <input
                        v-model="infoDataBD.clientesAfectados"
                        class="mt-1 h-10 w-[100%] rounded-lg border-2 border-[#E5E5E5] text-black"
                        type="number"
                        name="folio"
                        id="folio"
...
const { editarFolio, foliosData } = storeToRefs(foliosController);
const infoDataBD = ref(foliosData);
...
onBeforeMount(() => {
  infoDataBD.value = foliosController.foliosData;
});
