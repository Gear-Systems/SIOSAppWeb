<template>
  ...
  import Step1 from "@/views/Preventivo/Steps/Step1.vue";
  import Step2 from "@/views/Preventivo/Steps/Step2.vue";
  import Step3 from "@/views/Preventivo/Steps/Step3.vue";
