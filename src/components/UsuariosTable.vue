<template>
  <div class="flex h-full w-full rounded-lg bg-[#F8FAFB] pb-12">
    <div class="mt-6 w-full shadow-md sm:rounded-lg">
      <!-- Filtro -->
      <div class="mx-16 flex items-center border-b-2 border-gray-300 bg-[#F8FAFB]">
        <div v-if="false" class="rounded-full py-3 px-3 transition hover:bg-[#90B3F2]">
          <BoteBasuraIco />
        </div>
          ...
          <div class="relative mt-1">
            ...
            <transition leave-active-class="transition duration-100 ease-in" leave-from-class="opacity-100"
              ...
              <ListboxOptions
                ...
                <ListboxOption v-slot="{ active, selected }" v-for="filtro in filtros" :key="filtro.name"
                  :value="filtro" as="template">
                  <li :class="[
                    ...
                    <span v-if="selected" class="absolute inset-y-0 left-0 flex items-center pl-3 text-primario">
      ...
      <div class="flex min-h-[200px] justify-center bg-[#F8FAFB]">
        <table class="mx-14 mt-8 h-fit text-left text-sm text-gray-500 dark:text-gray-400">
          <tbody>
            <tr v-for="usuario in handlePagination().paginatedData.value"
              ...
              <td>
                <div class="mr-6">
                  <SwitchGroup>
                    <Switch v-model="usuario.disabled" :class="usuario.disabled ? 'bg-[#90B3F2]' : 'bg-primario'"
    ...
    <EditarUsuario v-if="usuarioData && openEditar" :data="usuarioData" :openEditar="openEditar"
